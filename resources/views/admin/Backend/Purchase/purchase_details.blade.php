		...
		<div class="card">
		  <div class="card-body p-3">
			...
			<div class="row">
				<div class="col">
					<div class="row mb-3">
						...
						<div class="col">
							...
							<option value="{{$purchase->supplier_id}}" selected="" disabled="">{{ $purchase->supplier->supplier_name }}</option>
						...
						<div class="row mb-3">
							...
							<div class="col"><input value="{{$purchase->chalan_no}}" class="form-control mb-3" type="text" id="chalan" name="chalan" required=""></div>
							
						</div>
						<div class="row mb-3">
							<div class="col-2"><label>Container Tracking No.</label></div>
				...
				<div class="col">
					<div class="row mb-3">
						<div class="col-2"><label>L/C Opening Date</label></div>
						<div class="col"><input value="{{ $purchase->purchase_date }}" class="form-control mb-3" type="date" id="quoDate" name="quoDate" required=""></div>
					</div>
					{{-- <div class="row mb-3">
					...
					<div class="row mb-3">
						<div class="col-2"><label>Last Date of Shipment</label></div>
						<div class="col"><input value="{{ $purchase->ldate }}" class="form-control mb-3" type="date" id="ldate" name="ldate"></div>
					</div>
					<div class="row mb-3">
						<div class="col-4"><label>Status</label></div>
						<select id="mySelec" name="status" class="form-control" required="">
							<option value="{{$purchase->status}}" selected="" disabled="">{{ $purchase->status }}</option>
							 <option value="Reached Port">Reached Port</option>	
							 <option value="Reached Factory">Reached Factory</option>	
							</select>
					</div>
