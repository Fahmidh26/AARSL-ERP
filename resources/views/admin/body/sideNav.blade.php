...
<div class="collapse hide" id="production" style="">
<ul class="nav ms-4 ps-3">
<li class="nav-item ">
<a class="nav-link {{ ($route == 'production.add')? 'active':'' }}" href="{{ route('production.add') }}">
<span class="sidenav-mini-icon"></span>
<span class="sidenav-normal">Add Production</span>
</a>
<a class="nav-link {{ ($route == 'todays-production')? 'active':'' }}" href="{{ route('todays-production') }}">
<span class="sidenav-mini-icon"></span>
